        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 bg-secondary border border-border rounded-lg text-foreground hover:bg-accent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {oauthLoading === "google" ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
          ...
          <button
            ...
            className="w-full mt-4 py-2.5 bg-transparent border border-border rounded-lg text-muted-foreground hover:text-foreground hover:border-muted-foreground transition-all text-sm"
          >
            Continue as guest
          </button>
        </div>
